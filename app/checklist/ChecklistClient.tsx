...
import { CalendarIcon } from "@radix-ui/react-icons" // Using Radix icon for Calendar as Lucide's Calendar is different
...
function ChecklistContent() {
  ...
  const handleMarkAsComplete = () => {
    // Construct query parameters to pass to the success page
